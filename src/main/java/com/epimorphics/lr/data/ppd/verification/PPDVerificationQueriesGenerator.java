 ...
 *
 */
public class PPDVerificationQueriesGenerator {
	...
	public PPDVerificationQueriesGenerator(Reader input, String outputDir, ProgressMonitor progressMonitor, ErrorHandler errorHandler) {
		this.input = input;
	...
	public void generate() {
		...
		String [] line;
		List<PPDVerificationQueryGenerator> queryGenerators = new ArrayList<PPDVerificationQueryGenerator>();
		...
		queryGenerators.add(new VerifyPropertyValueCountGenerator(outputDir, "other-property-type-count", PPDCSVLine.COLUMN_PROPERTY_TYPE, "O", "lrppi:propertyType", "lrcommon:otherPropertyType", errorHandler));
		...
		try {
	        while ((line = reader.readNext()) != null) {
	        	...
	        	for ( PPDVerificationQueryGenerator generator : queryGenerators) {
