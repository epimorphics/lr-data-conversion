...
public abstract class UKHPIVerificationQueryBase {
	
	private String outputDir;
	protected String queryName;
	ErrorHandler errorHandler;
	
	protected UKHPIVerificationQueryBase(String outputDir, String queryName, ErrorHandler errorHandler) {
	...
	protected void writeQuery(String query) {
		...
		writer.println("prefix ukhpi: <http://landregistry.data.gov.uk/def/ukhpi/>");
